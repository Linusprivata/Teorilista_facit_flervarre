...
\begin{AnswerBox}{Ditt svar (definition + ev. exempel/kommentar)}
\textbf{Exempel.} For $F=\left(\frac{1}{z},\frac{1}{z},\frac{1-x-y}{z^2}\right)$ far vi
\[
\operatorname{curl} F=
\begin{vmatrix}
...
1/z & 1/z & (1-x-y)/z^2
\end{vmatrix}
=\left(-\frac{1}{z^2}+\frac{1}{z^2},-\frac{1}{z^2}+\frac{1}{z^2},0-0\right)=0.
\]
Sa $F$ ar virvelfritt och darfor ocksa konservativt for $z>0$. Alltsa finns en potential $\phi$ sa att $F=\nabla\phi$ for $z>0$.
\end{AnswerBox}\vspace{2mm}
